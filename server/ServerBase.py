        ...
        for model_name in self.model_names:
            ...
            for epoch in range(epochs):
                ...
                for batch_idx, (seq, gt) in enumerate(distill_loader):
                    ...
                    gt_noise = noise[:, 3 * self.ctrl_fr_idx:3 * self.ctrl_fr_idx + 3, :, :]  # [N,3,H,W]
                    gtn_train = gt_train + gt_noise
                    ...
                    if step_count % 5 == 0:
                        print(
                            f'Epoch: [{epoch}/{epochs}], Step: [{step_count}],model:[{model_name}], loss:[{total_loss_batch}]')
