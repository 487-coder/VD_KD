...
train_data, test_data = partition_server_data(args.train_dataset,split_ratio =0.8,shuffle=True,seed= 10000)

client_dataset_path= partition(train_data,args.client_numbers)
val_dataset = TestDataset(test_data)
...
#分发数据集
distill_data, pretrain_data = partition_server_data(args.server_data,split_ratio =1.0,shuffle=True,seed= 10000)
